...
//The class Robot can store basic parameters of a robot such as velocity, direction, location, etc.
//And it defines some funtions which can prevent robots from collision. 

class Robot;

//The structure rangeSensor will record the information of other robots which come into the alert
